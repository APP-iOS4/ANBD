...
//    @Published var comments: [Comment] = []
    ...
    let mockArticleData: [Article] = [
        ...
        .init(writerID: "writerID", writerNickname: "닉네임1", category: .accua, title: "다시제목1", content: "내용내용5", imagePaths: ["DummyImage1"], likeCount: 400, commentCount: 25),
        .init(writerID: "writerID", writerNickname: "닉네임2", category: .accua, title: "다시제목2", content: "내용내용4", imagePaths: ["DummyPuppy2"], likeCount: 2, commentCount: 420),
        .init(writerID: "writerID", writerNickname: "닉네임3", category: .accua, title: "다시제목3", content: "내용내용3", imagePaths: ["DummyPuppy3"], likeCount: 30, commentCount: 302),
        .init(writerID: "writerID", writerNickname: "닉네임4", category: .accua, title: "다시제목4", content: "내용내용2", imagePaths: ["DummyPuppy1"], likeCount: 450, commentCount: 999),
